...
window.addEventListener('load', function () {
  _toConsumableArray(document.getElementsByClassName('menu-item-has-children')).forEach(function (element) {
    element.children[1].classList.add('hidden');
    element.addEventListener('click', function () {
      return _toConsumableArray(element.getElementsByClassName('sub-menu')).forEach(function (subElement) {
